          ...
          <div class="bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-800 rounded-lg p-6 mb-6">
            ...
            <div class="mt-6 flex flex-col gap-3">
              <button
                ...
                class="inline-flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                ...
                <span class="font-semibold tracking-wide">
                  {copiado ? '¡Copiado!' : 'Copiar valor del 4x1000'}
                </span>
              </button>
              ...
              <a
                ...
                class="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20BD5A] text-white px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                ...
                <div class="font-semibold tracking-wide text-center leading-tight">
                  <div>Compartir</div>
                  <div>resultado</div>
                </div>
              </a>
